...
if __name__ == "__main__":
    ...
    for constant_set in table.constant_sets:
        ...
        for assignment in constant_set.assignments:
            print(assignment.variation.name)
            print(assignment.run_range.min)
            print(assignment.run_range.max)
            print(assignment.request)
            print(assignment.author_id)
