...
\item Mr Bill whanted to use John data but tune table3 data to work with "data-john". Mr Bill 
...
ccdb goes looking for ``bill" parent, whitch is ``john" variation. ``john" variation has
...
is on top of variation hierarhy, so ``data1" will be returned. 
Summarizing:
\begin{verbatim}
