...
%feature("notabstract") DMySQLDataProvider;
...
public:
	...
	*/
	virtual DDirectory* GetDirectory(const std::string& path);
	 ...
	 * @return list of 
	 */
	virtual vector<DDirectory *> SearchDirectories(const std::string& searchPattern, const std::string& parentPath="", int take=0, int startWith=0);
	 ...
	 */
	virtual DConstantsTypeTable * GetConstantsTypeTable(const std::string& path, bool loadColumns=false);
	 ...
	 * @return new object of DConstantsTypeTable
	 */
	virtual DConstantsTypeTable * GetConstantsTypeTable(const std::string& name, DDirectory *parentDir, bool loadColumns=false);
	 ...
	 */
	virtual bool GetConstantsTypeTables(vector<DConstantsTypeTable *>& typeTables, const std::string& parentDirPath, bool loadColumns=false);
	 ...
	 */
	virtual vector<DConstantsTypeTable *> GetConstantsTypeTables(const std::string& parentDirPath, bool loadColumns=false);
	 ...
	 */
	virtual DConstantsTypeTable* CreateConstantsTypeTable(const std::string& name, const std::string& parentPath, int rowsNumber, std::map<string, string> columns, const std::string& comments ="");
	 ...
	 */
	virtual DRunRange* GetRunRange(int min, int max, const std::string& name = "");
	 ...
	 * @return   DRunRange* return NULL if not found or failed
	 */
	virtual DRunRange* GetRunRange(const std::string& name);
	 ...
	 */
	virtual DRunRange* GetOrCreateRunRange(int min, int max, const std::string& name="", const std::string& comment="");
	 ...
	 * @return 
	 */
	virtual bool GetRunRanges(vector<DRunRange *>& resultRunRanges, DConstantsTypeTable *table, const std::string& variation="", int take=0, int startWith=0 );
	 ...
	 * @return   DVariation*
	 */
	virtual DVariation* GetVariation(const std::string& name);
	 ...
	 */
	virtual DAssignment* GetAssignmentShort(int run, const std::string& path, const std::string& variation="default");
	 ...
	 * @return    DAssignment*
	 */
	virtual DAssignment* GetAssignmentShort(int run, const std::string& path, int version, const std::string& variation="default");
	 ...
	 * @return NULL if no assignment is found or error
	 */
	virtual DAssignment* GetAssignmentFull(int run, const std::string& path, const std::string& variation="default");
	 ...
	 * @return   DAssignment*
	 */
	virtual DAssignment* GetAssignmentFull(int run, const std::string& path, int version, const std::string& variation="default");
	 ...
	 */
	virtual bool GetAssignments(vector<DAssignment *> &assingments,const std::string& path, int runMin, int runMax, const std::string& runRangeName, const std::string& variation, time_t beginTime, time_t endTime, int sortBy=0, int take=0, int startWith=0);
	 ...
	 * @return 
	 */
	virtual bool GetAssignments(vector<DAssignment *> &assingments,const std::string& path, int run, const std::string& variation="", time_t date=0, int take=0, int startWith=0);
	 ...
	 * @return 
	 */
	virtual vector<DAssignment *> GetAssignments(const std::string& path, int run, const std::string& variation="", time_t date=0, int take=0, int startWith=0);
	 ...
	 * @return 
	 */
	virtual bool GetAssignments(vector<DAssignment *> &assingments,const std::string& path, const std::string& runName, const std::string& variation="", time_t date=0, int take=0, int startWith=0);
	 ...
	 * @return 
	 */
	virtual vector<DAssignment *> GetAssignments(const std::string& path, const std::string& runName, const std::string& variation="", time_t date=0, int take=0, int startWith=0);
