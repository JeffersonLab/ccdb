...
public:
	...
	*/
	 ...
	 * @return bool
	 */
	virtual bool SearchConstantsTypeTables(vector<DConstantsTypeTable *>& typeTables, const std::string& pattern, const std::string& parentPath = "", bool loadColumns=false, int take=0, int startWith=0 )=0;
