...
public:
	...
	*/
	virtual DDirectory* GetDirectory(const std::string& path)=0;
	 ...
	 */
	virtual DDirectory * const GetRootDirectory()=0;
	 ...
	 * @return list of 
	 */
	virtual vector<DDirectory *> SearchDirectories(const std::string& searchPattern, const std::string& parentPath="", int take=0, int startWith=0)=0;
	 ...
	 * @return   bool
	 */
	virtual bool UpdateDirectory(DDirectory *dir)=0;
	 ...
	 */
	virtual DConstantsTypeTable * GetConstantsTypeTable(const std::string& path, bool loadColumns=false)=0;
	 ...
	 * @return new object of DConstantsTypeTable
	 */
	virtual DConstantsTypeTable * GetConstantsTypeTable(const std::string& name, DDirectory *parentDir, bool loadColumns=false)=0;
	 ...
	 * @return new object of DConstantsTypeTable
	 */
	virtual bool GetConstantsTypeTables(vector<DConstantsTypeTable *>& typeTables,const std::string& parentDirPath, bool loadColumns=false) =0;
	 ...
	 */
	virtual vector<DConstantsTypeTable *> GetConstantsTypeTables (DDirectory *parentDir, bool loadColumns=false)=0;
	 ...
	 * @return vector of constants
	 */
	virtual bool GetConstantsTypeTables(vector<DConstantsTypeTable *>& typeTables, DDirectory *parentDir, bool loadColumns=false) =0;
	 ...
	 * @return bool
	 */
	virtual bool SearchConstantsTypeTables(std::vector<DConstantsTypeTable *>& typeTables, const std::string& pattern, const std::string& parentPath = "", bool loadColumns=false, int take=0, int startWith=0 )=0;
	 ...
	 */
	virtual std::vector<DConstantsTypeTable *> SearchConstantsTypeTables(const std::string& pattern, const std::string& parentPath = "", bool loadColumns=false, int take=0, int startWith=0 )=0;
	 ...
	 */
	virtual int CountConstantsTypeTables(DDirectory *dir)=0;
	 ...
	 * @return vector of constants
	 */
	virtual bool LoadColumns(DConstantsTypeTable* table) =0;
	 ...
	 * @return bool
	 */
	virtual bool CreateConstantsTypeTable(DConstantsTypeTable *table)=0;
	 ...
	 */
	virtual DConstantsTypeTable* CreateConstantsTypeTable(const std::string& name, const std::string& parentPath, int rowsNumber, std::map<std::string, std::string> columns, const std::string& comments ="");
	 ...
	 * @return NULL if failed, pointer to created object otherwise
	 */
	virtual DConstantsTypeTable* CreateConstantsTypeTable(const std::string& name, DDirectory *parentDir, int rowsNumber, std::map<string, string> columns, const std::string& comments ="");
	 ...
	 * @return bool
	 */
	virtual bool UpdateConstantsTypeTable(DConstantsTypeTable *table)=0;
	 ...
	 * @return   bool
	 */
	virtual bool CreateRunRange(DRunRange *run)=0;
	 ...
	 */
	virtual DRunRange* GetRunRange(int min, int max, const std::string& name = "")=0;
	 ...
	 * @return 
	 */
	virtual bool GetRunRanges(vector<DRunRange *>& resultRunRanges, DConstantsTypeTable *table, const std::string& variation="", int take=0, int startWith=0 )=0;
	 ...
	 * @return 
	 */
	virtual bool GetRunRanges(vector<DRunRange *>& resultRunRanges, const std::string& typeTablePath, const std::string& variation="",int take=0, int startWith=0 );
	 ...
	 * @return   DRunRange* return NULL if not found or failed
	 */
	virtual DRunRange* GetRunRange(const std::string& name)=0;
	 ...
	 */
	virtual DRunRange* GetOrCreateRunRange(int min, int max, const std::string& name="", const std::string& comment="")=0;
	 ...
	 */
	virtual bool UpdateRunRange(DRunRange* run)=0;
	 ...
	 * @return   DVariation*
	 */
	virtual DVariation* GetVariation(const std::string& name)=0;
	 ...
	 * @return 
	 */
	virtual bool GetVariations(vector<DVariation *>& resultVariations, DConstantsTypeTable *table, int run=0, int take=0, int startWith=0 )=0;
	 ...
	 * @return 
	 */
	virtual vector<DVariation *> GetVariations(DConstantsTypeTable *table, int run=0, int take=0, int startWith=0 )=0;
	 ...
	 * @return 
	 */
	virtual bool GetVariations(vector<DVariation *>& resultVariations, const std::string& path, int run=0, int take=0, int startWith=0 );
	 ...
	 */
	virtual bool CreateVariation(DVariation *variation)=0;
	 ...
	 * @return true if success  
	 */
	virtual bool UpdateVariation(DVariation *variation) =0;
     ...
     */
	virtual DAssignment* GetAssignmentShort(int run, const std::string& path, const std::string& variation="default")=0;
     ...
     * @return DAssignment object or NULL if no assignment is found or error
     */
    virtual DAssignment* GetAssignmentShort(int run, const string& path, time_t time, const string& variation="default")=0;
     ...
     * @return DAssignment object or NULL if no assignment is found or error
     */
    virtual DAssignment* GetAssignmentShortByVersion(int run, const string& path, int version, const string& variation="default")=0;
	 ...
	 */
	virtual DAssignment* GetAssignmentFull(int run, const std::string& path, const std::string& variation="default")=0;
	 ...
	 * @return   DAssignment*
	 */
	virtual DAssignment* GetAssignmentFull(int run, const std::string& path, int version, const std::string& variation="default")=0;
	 ...
	 */
	virtual bool CreateAssignment(DAssignment *assignment) = 0;
	 ...
	 * @return NULL if failed, DAssignment reference if success
	 */
	virtual DAssignment* CreateAssignment(const vector<vector<string> > &data, const std::string& path, const std::string& runRangeName, const std::string& variationName, const std::string& comments);
	 ...
	 */
	virtual bool GetAssignments(vector<DAssignment *> &assingments,const std::string& path, int runMin, int runMax, const std::string& runRangeName, const std::string& variation, time_t beginTime, time_t endTime, int sortBy=0, int take=0, int startWith=0)=0;
	 ...
	 * @return 
	 */
	virtual bool GetAssignments(vector<DAssignment *> &assingments,const std::string& path, int run, const std::string& variation="", time_t date=0, int take=0, int startWith=0)=0;
	 ...
	 * @return assingments
	 */
	virtual vector<DAssignment *> GetAssignments(const std::string& path, int run, const std::string& variation="", time_t date=0, int take=0, int startWith=0)=0;
	 ...
	 * @return 
	 */
	virtual bool GetAssignments(vector<DAssignment *> &assingments,const std::string& path, const std::string& runName, const std::string& variation="", time_t date=0, int take=0, int startWith=0)=0;
	 ...
	 * @return 
	 */
	virtual vector<DAssignment *> GetAssignments(const std::string& path, const std::string& runName, const std::string& variation="", time_t date=0, int take=0, int startWith=0)=0;
	 ...
	 * @return 
	 */
	virtual bool UpdateAssignment(DAssignment* assignment)=0;
	 ...
	 * @return true if success
	 */
	virtual bool DeleteAssignment(DAssignment* assignment)=0;
	 ...
	 */
	virtual bool FillAssignment(DAssignment* assignment)=0;
	 ...
	 */
	 virtual std::vector<DCCDBError *> GetErrors();
